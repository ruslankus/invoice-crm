...
<body>
    ...
    <tr>
        ...
        <td valign="top">
            <div class="infoRight">
            	<h1 align="center" class="font24">Sąskaita-faktūra</h1>
                <hr/>
                <table width="100%">
                	<tr>
                    ...
                    <tr>
                    	<td><p class="font14"><strong>Sąskaitos Nr:</strong></p></td>
                    ...
                    <tr>
                    	<td><p class="font14"><strong>Apmokėti per:</strong></p></td>
