...
<body>
    ...
    <!--- end header -->
        ...
        <table width="100%">
   	    <tr class="thead">
            ...
            <td class="colorWh font12">&nbsp;Qyantity</td>
        ...
        <?php if($ops_act->count() > 0):?>
            <tr>            	
                ...
                <td class="font12">&euro; <?=number_format($op_act_name->op_cost_eur,2); ?></td>
        ...
        <?php if($ops1->count() > 0):?>
            <tr>            	
                ...
                <td class="font12">&euro; <?=number_format($ops1_name->op_cost_eur,2)?></td>
        ...
        <?php if($ops2->count() > 0):?>
            <tr>            	
                ...
                <td class="font12">&euro; <?=number_format($ops2_name->op_cost_eur,2)?></td>
        ...
        <?php if($ops3->count() > 0):?>
            <tr>            	
                ...
                <td class="font12">&euro; <?=number_format($ops3_name->op_cost_eur,2)?></td>
    ...
    <table width="100%" >
    	<tr class="thead">
        	<td class="colorWh font12">&nbsp;Date</td>
        	<td class="colorWh font12">&nbsp;Service</td>
            <td class="colorWh font12">&nbsp;Item</td>
            <td class="colorWh font12">&nbsp;Description</td>            
