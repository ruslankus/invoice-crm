    ...
    <tr>
        ...
        <td valign="top">
            <div class="infoRight">
                ...
                <table width="100%">
                	<tr>
                    	<td><p class="font14"><strong>Timeline:</strong></p></td>
                        <td><p class="font14"><?=date('d/m/Y',$date_from)?> - <?=date('d/m/Y',$date_to)?></p></td>
                    </tr>
                    <tr>
                    	<td><p class="font14"><strong>Date:</strong></p></td>
                        <td><p class="font14"><?=date('d/m/Y')?></p></td>
                    </tr>
                    <tr>
                    	<td><p class="font14"><strong>Serija Nr:</strong></p></td>
                        <td><p class="font14"><?=$inv_full_nr?></p></td>
                    </tr>
                    <tr>
                    	<td><p class="font14"><strong>Invoice Nr:</strong></p></td>
                        <td><p class="font14">LT<?=$inv_nr?></p></td>
                    </tr>
                    <tr>
                    	<td><p class="font14"><strong>Currency :</strong></p></td>
                        <td><p class="font14">EUR</p></td>
                    </tr>
                    <tr>
                    	<td><p class="font14"><strong>Payment Term:</strong></p></td>
                        <td><p class="font14">14 days</p></td>
                    </tr>
                </table>
            </div><!-- /infoRight -->
        </td>
    ...
    <!--- end header -->
        ...
        <table width="100%">
   	    <tr class="thead">
            ...
            <td class="colorWh">ITEM CODE</td>
            <td class="colorWh">QUANTITY</td>
            <td class="colorWh">UNIT VALUE</td>
            <td class="colorWh">TOTAL VALUE</td>
        </tr>
