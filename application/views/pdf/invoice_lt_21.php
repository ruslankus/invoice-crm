...
<body>
    ...
    <tr>
                ...
                <div class="infoWe">
                    <table width="100%" valign='top'>
                        ...
                        <tr>
                            ...
                            <td>
                                <p class="font10">Įmonės kodas: 302496605</p>
                                <p class="font10">PVM mokėtojo kodas: LT100005320519</p>
        ...
        <td valign="top">
            <div class="infoRight">
            	<h1 align="center" class="font24">PVM Sąskaita-faktūra</h1>
                <hr/>
                <table width="100%">
                	<tr>
                    	<td><p class="font12"><strong>Laikotarpis:</strong></p></td>
                        <td><p class="font10"><?=date('d/m/Y',$date_from)?> - <?=date('d/m/Y',$date_to)?></p></td>
                    </tr>
                    <tr>
                    	<td><p class="font12"><strong>Data:</strong></p></td>
                        <td><p class="font10"><?=date('d/m/Y')?></p></td>
                    </tr>
                    <tr>
                    	<td><p class="font12"><strong>Serija Nr:</strong></p></td>
                        <td><p class="font10"><?=$inv_full_nr?></p></td>
                    </tr>
                    <tr>
                    	<td><p class="font12"><strong>Sąskaitos Nr:</strong></p></td>
                        <td><p class="font10">LT<?=$inv_nr?></p></td>
                    </tr>
                    <tr>
                    	<td><p class="font12"><strong>Valiuta :</strong></p></td>
                        <td><p class="font10">LTL</p></td>
                    </tr>
                    <tr>
                    	<td><p class="font12"><strong>Apmokėti per:</strong></p></td>
                        <td><p class="font10">14 dienų</p></td>
                    </tr>
                </table>
            </div><!-- /infoRight -->
        </td>
    ...
    <!--- end header -->
        ...
        <table width="100%">
   	    <tr class="thead ">
            ...
            <td class="colorWh font12" style="width: 40%;">Pavadinimas</td>
            <td class="colorWh font12">&nbsp;Kodas</td>
            <td class="colorWh font12">&nbsp;Kiekis</td>            
            <td class="colorWh font12">&nbsp;Kaina,EUR</td>
            <td class="colorWh font12">&nbsp;Kaina,LTL</td>
            <td class="colorWh font12">&nbsp;Total,EUR</td>
            <td class="colorWh font12">&nbsp;Viso,LTL</td>
        </tr>
        ...
        <tr>
            ...
            <td colspan="6">
            	...
            	<table width="100%" style="width: 100%;" class="borderTop font12"> 
                    ...
                    <tr class="font13">
                       <td>Bendra suma su PVM / Subtotal</td>
        ...
        <td valign="top">
            <div class="infoRight">
                ...
                <table width="100%">
                    ...
                    <tr>
                    	<td><p class="font12"><strong>Saskaitos Nr:</strong></p></td>
                        <td><p class="font10">LT<?=$inv_nr?></p></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                    	<td><p class="font12"><strong>Apmoketi per:</strong></p></td>
                        <td><p class="font10">14 dienų</p></td>
                    </tr>
                </table>
            </div><!-- /infoRight -->
    ...
    <table width="100%" >
    	<tr class="thead">
        	<td class="colorWh font12">&nbsp;Data</td>
        	<td class="colorWh font12">&nbsp;Paslauga</td>
            <td class="colorWh font12">&nbsp;Pavadinimas</td>
            <td class="colorWh font12">&nbsp;Kodas</td>            
            <td class="colorWh font12">&nbsp;Kaina,EUR</td>
            <td class="colorWh font12">&nbsp;Kaina,LTL</td>
        </tr>
